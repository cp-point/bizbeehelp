...
export const Hero = styled.section`
  ...
  padding: 80px 20px;
  background:
    linear-gradient(rgba(0, 7, 22, 0.7), rgba(0, 7, 22, 0.7)),
    url('/assets/images/faq-intro-bg.png') center 60% / cover no-repeat;
  overflow: hidden;
  ...
  @media (max-width: 767px) {
    ...
    background:
      linear-gradient(rgba(0, 7, 22, 0.7), rgba(0, 7, 22, 0.7)),
      url('/assets/images/faq-intro-bg.png') center / cover no-repeat;
  }
`;
...
export const FooterShortcut = styled.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 24px;
